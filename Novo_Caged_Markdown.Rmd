...
kable(df_Extrativa_Estoque, allign = "c", caption = "Quantidade de trabalhadores na subclasse Extração de gemas (pedras preciosas e semipreciosas) por UF") %>% kable_styling(bootstrap_options = "striped", full_width = FALSE)
...
kable(
  head(
  arrange(df_Extrativa_Estoque_Mun, desc(Estoque_01Jan)), 20), allign = "c", caption = "Quantidade de vínculos trabalhistas na Extrativa Mineral por Município") %>% kable_styling(bootstrap_options = "striped", full_width = FALSE)
