...
kableExtra::kable(df_Estoques, caption = "Estoques e Saldos de Trabalhadores", align = "c") %>% kable_styling(bootstrap_options = "striped", full_width = FALSE, )

```

</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td><td>

```{r Estoques e Saldos por Trimestre, echo=FALSE, message=FALSE}
...
kableExtra::kable(df_Estoques_Extrativa, caption = "Estoques e Saldos na Extrativa Mineral", align = "c") %>% kable_styling(bootstrap_options = "striped", full_width = FALSE)
...
df_Extrativa_Grupo_Salario <-
  left_join(
    summarise(
      ...
      "salário_médio" = round(mean(salário, na.rm = TRUE, trim = 0.01), 1)
    ),
    cnae[cnae$grupo != 0 &
           cnae$classe == 0 &
           cnae$subclasse == 0, c("grupo", "denominação")],
...
### Saldos na Extrativa por UF_sigla, Grupo e Trimestre
...
### Extrativa por UF_sigla, Subclasse e Trimestre
...
kable(
  ...
  allign = "c", caption = "Saldos Transformação Mineral por Grupo") %>% kable_styling(bootstrap_options = "striped", full_width = FALSE)
...
kable(
  ...
  allign = "c", caption = "Salários da Transformação Mineral por Grupo") %>% kable_styling(bootstrap_options = "striped", full_width = FALSE)
...
kable(
  ...
  allign = "c", caption = "Saldos Transformação Mineral por Classe") %>% kable_styling(bootstrap_options = "striped", full_width = FALSE)
...
kable(
  ...
  allign = "c", caption = "Salários da Transformação Mineral por Classe") %>% kable_styling(bootstrap_options = "striped", full_width = FALSE)
...
df_Transformação_Variacao_Estoque <- a[,c("denominação", "Estoque_01Jan", "2020.1","2020.2","2020.3","2020.4","delta_01TRI", "delta_02TRI")]

kable(df_Transformação_Variacao_Estoque, allign = "c", caption = "Estoque, Saldos e Variações por Classe") %>% kable_styling(bootstrap_options = "striped", full_width = FALSE)
...
#
#kable(arrange(estoque_Grupo_Trimestre, desc(`delta_03SEM`)), allign = "c") %>% kable_styling(bootstrap_options = "striped", full_width = FALSE)
